...
export default function AppLayout({ screen, children, onNavigate }) {
  ...
  const SIDEBAR_SCREENS = ['dashboard', 'campaigns', 'my-campaigns', 'offers', 'wallet', 'profile', 'notifications', 'campaign-detail', 'allocate', 'allocation-success', 'boost', 'membership', 'referral'];
