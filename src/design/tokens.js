...
export const tokens = deepFreeze({
  colors: {
    ...
    overlay: 'var(--overlay)',
    accentSoft: 'rgba(238,140,70,0.1)',
    accentBorder: 'rgba(238,140,70,0.3)',
  },
  ...
  light: {
    ...
    accentSoft: 'rgba(238,140,70,0.10)',
    accentBorder: 'rgba(238,140,70,0.28)',
  ...
  shadow: {
    ...
    glow: '0 8px 24px rgba(238,140,70,0.35)',
    glowStrong: '0 16px 40px rgba(238,140,70,0.5)',
